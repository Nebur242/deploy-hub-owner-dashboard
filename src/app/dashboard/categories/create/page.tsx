...
import { useCreateCategoryMutation, useFindAllCategoriesQuery } from "@/store/features/categories";
...
export default function Page() {
  ...
  const [createCategory, { isLoading, error: createCategoryError, isSuccess }] = useCreateCategoryMutation();
  ...
  const errorMessage = (() => {
    if (!createCategoryError) return null;

    // Handle the specific error format returned by the API
    if (typeof createCategoryError === 'object' && createCategoryError !== null && 'data' in createCategoryError) {
      const errorData = createCategoryError.data as any;
    ...
    <div className="container mx-auto py-6 max-w-6xl">
      <div className="flex items-center justify-between mb-8">
        ...
        <div className="flex items-center gap-2">
          ...
          <Button onClick={form.handleSubmit(onSubmit)} disabled={isLoading || success}>
            {isLoading && <Loader2 className="mr-2 h-4 w-4 animate-spin" />}
            {success && <CheckCircle2 className="mr-2 h-4 w-4" />}
            {isLoading ? "Creating..." : success ? "Created" : "Save category"}
          </Button>
        </div>
      </div>
      ...
      {success && (
        <Alert className="mb-6 bg-green-50">
          ...
          <AlertDescription>
            Category created successfully. Redirecting to categories page...
          </AlertDescription>
        </Alert>
      )}
            ...
            <div className="space-y-6">
              ...
              <Card>
                ...
                <CardContent className="space-y-6">
                  ...
                  {/* Enhanced Parent Category with DropdownMenu - Fixed search behavior */}
                  <FormField
                    control={form.control}
                    name="parentCategory"
                    render={({ field }) => (
